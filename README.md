...
Podczas pierwszego uruchomienia aplikacja sprawdza istnienie konta administratora. Jeśli nie istnieje, zostanie utworzone automatycznie (dane te można zmienić po zalogowaniu w panelu uzytkownika lub przez Program.cs):
